...
CERT_DIR="/work"
BARG=""
BCMD="bosh create-env bosh-deployment/bosh.yml"
BARG="$BARG -o bosh-deployment/docker/cpi.yml"
BARG="$BARG -o bosh-deployment/jumpbox-user.yml"
...
BARG="$BARG -v docker_host=tcp://192.168.99.100:2376"

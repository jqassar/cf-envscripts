...
generateCert director $DIRECTOR_IP # <--- Replace with public Director IP
generateCert uaa-web $DIRECTOR_IP # <--- Replace with public Director IP
generateCert uaa-sp $DIRECTOR_IP # <--- Replace with public Director IP
